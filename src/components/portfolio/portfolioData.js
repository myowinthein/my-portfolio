    ...
    'projects': [
      ...
      // StudyMe
      {
        ...
        'preview': [
          ...
          {"platform": "Android", "url": "https://play.google.com/store/apps/details?id=com.studyme"},
      ...
      // Wellspring Portal
      {
        ...
        'media': [
          ...
          {'type': 'image', 'url': wellspringImg2},
          {'type': 'image', 'url': wellspringImg3},
          {'type': 'image', 'url': wellspringImg4},
          {'type': 'image', 'url': wellspringImg5},
        ],
        'preview': [
      ...
      // Tavis
      {
        ...
        'preview': [
          ...
          {"platform": "Android", "url": "https://play.google.com/store/apps/details?id=com.tavis.tavisapp"},
    ...
    'projects': [
      ...
      // fastforward
      {
        ...
        'media': [
          ...
          {'type': 'image', 'url': fastforwardImg1},
          {'type': 'image', 'url': fastforwardImg2},
          {'type': 'image', 'url': fastforwardImg3},
  ...
  // Civic Platforms
  {
    ...
    'projects': [
      ...
      // Recycle Myanmar
      {
        ...
        'description': [
          `Recycle Myanmar is an on demand waste collection platform connecting households with waste collectors for recyclable pickup, operating on a ride-hailing model for waste. When a household submits a pickup request, the backend identifies all available collectors within a configurable radius and dispatches push notifications to them simultaneously. The platform also includes a B2B recycling company directory where businesses list the materials they buy and sell, view market prices, and find trading partners.`,
          `I built the backend end to end on Laravel, designing a single application that serves four surfaces through domain scoped routing: an admin panel and three JWT authenticated API groups for Givers, Pickers, and the company directory. Collector dispatch uses the Haversine formula in raw SQL to find available Pickers within radius, then bulk sends push notifications via Firebase Cloud Messaging and Pushy simultaneously. Unaccepted requests are auto cancelled by a delayed Redis queue job after three minutes. All content fields store trilingual JSON with separate English, Unicode, and Zawgyi Myanmar values per field.`
        ...
        'media': [
          ...
          {'type': 'video', 'url': '/assets/portfolio/recycle_myanmar/v2.mp4'},
